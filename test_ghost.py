...
class TestGhost(unittest.TestCase):
	...
	def test_check_word(self):
		self.assertTrue(self.gg.check_word('apple'),'whole word, lowercase')
		self.assertTrue(self.gg.check_word('Apple'), 'whole word, mixed case')
		self.assertFalse(self.gg.check_word('!'), 'non-word')
		self.assertFalse(self.gg.check_word('multi word') ,'multi word')
		self.assertFalse(self.gg.check_word('badWord'), 'word not in dictionary')

	def test_check_possible_word(self):
		self.assertTrue(self.gg.check_possible_word('apple'),'whole word')
		self.assertTrue(self.gg.check_possible_word('zed'), 'whole word')
		self.assertTrue(self.gg.check_possible_word('perat'),'middle of word')
		self.assertTrue(self.gg.check_possible_word('xyl'), 'start of word')
		self.assertTrue(self.gg.check_possible_word('cut'), 'end of word')

		with self.assertRaises(ValueError):
			self.gg.check_possible_word('xy')

		# End of one word concatenated with beginning of next word
		self.assertFalse(self.gg.check_possible_word('leban'))
